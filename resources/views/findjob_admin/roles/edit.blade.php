                ...
                <div class="col-sm-12 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="fw-bold float-left"><strong><i class="fa fa-edit" aria-hidden="true"></i> Edit Role</strong></h3>
                        ...
                        <div class="card-body">
                            <form action="{{ route('roles.update',$role->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ $role->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Role Name">
                                    @error('name')
                                            ...
                                            @foreach ($getPermissions as $permission)
                                                <tr>
                                                    ...
                                                    @foreach ($permission['group'] as $group)
                                                        ...
                                                        @endforeach
                                                        <td>
                                                            <label><input type="checkbox" {{ $checked }} value="{{ $group['id'] }}" name="permission_id[]"> <small>{{ $group['name'] }}</small></label>
                                                        </td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
